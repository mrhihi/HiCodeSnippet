/*
參考： https://docs.microsoft.com/zh-tw/troubleshoot/sql/performance/understand-resolve-blocking
*/

-- 用 活動監視器：
/*
    打開「活動監視器」，尋找 head blocker 欄位，篩選欄位內容為 1 的，即為死結的源頭
*/
